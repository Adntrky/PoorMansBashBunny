...
if [ "$keyboardLayout" == "US" ] || [ "$keyboardLayout" == "" ]; then
	...
	conv["*"]='kp-multiply'
        ...
        conv["<"]='eu-backslash'
        conv[","]='comma'
        conv[">"]='left-shift eu-backslash'
        conv["?"]='left-shift dash'
        conv["\\"]='right-alt eu-backslash'
        ...
        conv["&"]='left-shift 6'
        conv["*"]='kp-multiply'
elif [ "$keyboardLayout" == "TR" ]; then
        conv[" "]='space'
        conv["!"]='left-shift 1'
        conv["."]='slash'
        conv["\`"]='right-alt backslash'
        conv["~"]='right-alt rbracket'
        conv["+"]='left-shift 4'
        conv["="]='left-shift 0'
        conv["_"]='left-shift equal'
        conv["-"]='equal'
        conv["\""]='backquote'
        conv["\\"]='right-alt minus'
        conv["'"]='left-shift 2'
        conv[":"]='left-shift slash'
        conv[";"]='left-shift backslash'
        conv["<"]='eu-backslash'
